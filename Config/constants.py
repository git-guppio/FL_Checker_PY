...
# Tabelle vuote da utilizzare per estrazioni SAP che non restituiscono valori
empty_tab_ZPMR_CONTROL_FL1 = """
-------------------------------------------------------------------------------------------------------------------------------------------------------
|  Mdt|Progressivo|Str. |Maschera edit.      |C|Definizione|Liv.Sede|Pse|Valore Livello|Indicatore|Rilevante per Esim|Rilevante per PWAY|Tipo Elemento|
-------------------------------------------------------------------------------------------------------------------------------------------------------

-------------------------------------------------------------------------------------------------------------------------------------------------------
"""
empty_tab_ZPMR_CONTROL_FL2 = """
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|  Mdt|Progressivo|Str. |Maschera edit.      |C|Definizione|Liv.Sede|Valore Livello|Descrizione del Valore|Liv. rif. ST|Tipo Elemento|Data di Modifica|Ora di Modifica|Autore Mod.|
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
"""
empty_tab_ZPMR_CTRL_ASS = """
------------------------------------------------------------------------------------------------------------------------------
|  Mdt|Valore Livello|Valore Liv. Superiore|Valore Liv. Superiore|Str. |C|Liv.Sede|Sezione|Tipologia|Componente|Tipo Elemento|
------------------------------------------------------------------------------------------------------------------------------

------------------------------------------------------------------------------------------------------------------------------
"""
empty_tab_ZPM4R_GL_T_FL = """
------------------------------------------------------------------------------------------------------------------------------------------------
|  Mdt|Valore Livello|Valore Liv. Superiore|Valore Liv. Superiore|Str. |C|Liv.Sede|Tipo ogg.|Prof.cat.|Codice attività Addizionale|Documento PM|
------------------------------------------------------------------------------------------------------------------------------------------------
